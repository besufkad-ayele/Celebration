...
const ALL_PHOTOS = [
  { url: "/gallery/recent.png", caption: "The current vibe", size: "large" },
  { url: "/gallery/0-7.png", caption: "Where it all began", size: "small" },
  { url: "/gallery/IMG_1850.png", caption: "Timeless elegance", size: "wide" },
  { url: "/gallery/8-14.png", caption: "Growing up fast", size: "small" },
  { url: "/gallery/12-18.png", caption: "Teenage dreams", size: "large" },
  { url: "/gallery/18-24.png", caption: "University days", size: "small" },
  { url: "/gallery/recent1.png", caption: "Golden hour", size: "small" },
  { url: "/gallery/IMG_2393.png", caption: "Radiance redefined", size: "wide" },
  { url: "/gallery/recent2.png", caption: "Pure joy", size: "small" },
  { url: "/gallery/0-7(1).png", caption: "Pure innocence", size: "large" },
  { url: "/gallery/recent3.png", caption: "Night out energy", size: "small" },
  { url: "/gallery/recent4.png", caption: "Sunset smiles", size: "small" },
  { url: "/gallery/18-24(2).png", caption: "Adventure awaits", size: "wide" },
  { url: "/gallery/recent5.png", caption: "Serene moments", size: "small" },
  { url: "/gallery/0-7(2).png", caption: "Little princess", size: "large" },
  { url: "/gallery/recen6.png", caption: "Celebration time", size: "small" },
  { url: "/gallery/recent7.png", caption: "Candid laughter", size: "small" },
  { url: "/gallery/18-24(3).png", caption: "Bestie moments", size: "wide" },
  { url: "/gallery/recent8.png", caption: "Classic beauty", size: "small" },
  { url: "/gallery/0-7(3).png", caption: "Those curls!", size: "large" },
  { url: "/gallery/recent9.png", caption: "Final count down", size: "small" },
  { url: "/gallery/photo_2026-03-11_18-36-57.png", caption: "Dreamy eyes", size: "small" },
  { url: "/gallery/photo_2026-03-11_18-36-59.png", caption: "Stylishly bold", size: "wide" },
  { url: "/gallery/photo_2026-03-11_18-37-01.png", caption: "Soft whispers", size: "small" },
  { url: "/gallery/photo_2026-03-11_18-37-05.png", caption: "Infinite charm", size: "large" },
  { url: "/gallery/photo_2026-03-11_18-37-06.png", caption: "A heart of gold", size: "small" },
  { url: "/gallery/photo_2026-03-11_18-37-22.png", caption: "Elegance in motion", size: "small" },
  { url: "/gallery/photo_2026-03-11_18-37-24.png", caption: "Simply iconic", size: "wide" },
];
